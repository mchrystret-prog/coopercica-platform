  ...
  return <Section id="drogaria" className={styles.section} aria-labelledby="pharmacy-title" tabIndex={-1}>
    <Container className={styles.shell}>
      <div className={styles.content}>
        <SectionHeader id="pharmacy-title" eyebrow={content.eyebrow||pharmacy.eyebrow} title={[content.title1||"Muito além",content.title2||"dos medicamentos."]} description={content.description||pharmacy.description} stacked />
